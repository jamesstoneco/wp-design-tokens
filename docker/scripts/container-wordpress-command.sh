...
echo "Wait for folder wp-design-tokens in $(pwd)/wp-content/plugins ..."
while [ ! -d "wp-content/plugins/wp-design-tokens" ]; do sleep 1; done;
...
if ! $(wp --allow-root core is-installed); then
    ...
    wp --allow-root plugin activate wp-design-tokens
